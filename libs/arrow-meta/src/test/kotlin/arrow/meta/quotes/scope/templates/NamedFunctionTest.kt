...
class NamedFunctionTest {
  ...
  companion object {
    private val helloWorldFunction =
      """ fun helloWorld(): String = "Hello ΛRROW Meta!" """.namedFunction()

    private val helloWorldPrivateFunction =
      """ private fun helloWorld(): String = "Hello ΛRROW Meta!" """.namedFunction()

    private val helloWorldInlineFunction =
      """ private inline fun helloWorld(): String = "Hello ΛRROW Meta!" """.namedFunction()

    private val extensionFunction = """ fun Int.identity() = this """.namedFunction()

    private val descriptorFunction =
      """ fun descriptorEvaluation(): String = "Hello ΛRROW Meta!" """.namedFunction()
