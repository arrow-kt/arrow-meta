...
object Noop {
  ...
  fun <A> nullable7(): (Any?, Any?, Any?, Any?, Any?, Any?, Any?) -> A? = { _, _, _, _, _, _, _ ->
    null
  }
  ...
  fun <A> emptyCollection4(): (Any?, Any?, Any?, Any?) -> Collection<A> = { _, _, _, _ ->
    emptyList()
  }
  fun <A> emptyCollection5(): (Any?, Any?, Any?, Any?, Any?) -> Collection<A> = { _, _, _, _, _ ->
    emptyList()
  }
