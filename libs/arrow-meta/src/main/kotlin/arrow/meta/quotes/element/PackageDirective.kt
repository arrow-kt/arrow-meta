 ...
 * import arrow.meta.quotes.Transform import arrow.meta.quotes.packageDirective
 *
 * val Meta.reformatPackage: CliPlugin get() = "ReformatPackage" { meta(
 * ```
...
data class PackageDirective(
  ...
  val packages: ScopedList<KtSimpleNameExpression> =
    ScopedList(value = value?.packageNames ?: listOf(), separator = "."),
