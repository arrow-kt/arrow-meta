 ...
 * This function is used by more specific instances like
 * [constraintsFromConstructor] and [constraintsFromFunctionLike]
 */
...
private fun <A : Constructor<A>> Constructor<A>.constraintsFromConstructor(
  ...
  (getContainingClassOrObject().getAnonymousInitializers() + listOf(this)).flatMap {
    it.constraintsFromGenericDeclaration(solverState, context, parameters)
