...
internal fun Solver.rationalEquals(args: List<Formula>): BooleanFormula? =
  rationals {
    if (args.size == 2) {
...
internal fun Solver.rationalPlus(args: List<Formula>): NumeralFormula.RationalFormula? =
  rationals {
    if (args.size == 2) {
      val (left, right) = args.rational()
      add(left, right)
...
internal fun Solver.rationalGreaterThan(args: List<Formula>): BooleanFormula? =
  rationals {
    if (args.size == 2) {
      val (left, right) = args.rational()
...
internal fun Solver.rationalGreaterThanOrEquals(args: List<Formula>): BooleanFormula? =
  rationals {
    if (args.size == 2) {
      val (left, right) = args.rational()
...
internal fun Solver.rationalLessThan(args: List<Formula>): BooleanFormula? =
  rationals {
    if (args.size == 2) {
      val (left, right) = args.rational()
      lessThan(left, right)
...
internal fun Solver.rationalLessThanOrEquals(args: List<Formula>): BooleanFormula? =
  rationals {
    if (args.size == 2) {
      val (left, right) = args.rational()
