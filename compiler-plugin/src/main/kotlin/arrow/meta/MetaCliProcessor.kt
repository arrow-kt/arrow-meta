...
object ArrowMetaConfigurationKeys {
    val GENERATED_SRC_OUTPUT_DIR: CompilerConfigurationKey<List<String>> =
      CompilerConfigurationKey.create("Arrow Meta generated source output directory")
}
...
class MetaCliProcessor : CommandLineProcessor {
  ...
  override fun processOption(option: AbstractCliOption, value: String, configuration: CompilerConfiguration) = when (option) {
    ARROW_META_GENERATED_SRC_OUTPUT_DIR -> configuration.appendList(ArrowMetaConfigurationKeys.GENERATED_SRC_OUTPUT_DIR, value)
