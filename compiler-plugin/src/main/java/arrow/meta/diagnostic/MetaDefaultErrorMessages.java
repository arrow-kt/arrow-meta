...
public class MetaDefaultErrorMessages implements DefaultErrorMessages.Extension {
    ...
    static {
        ...
        MAP.put(AmbiguousProof,
                "This {0} has following conflicting proof/s: {1}.\nPlease disambiguate resolution, by either declaring only one internal orphan / public proof over the desired type/s or remove ubiquitous proofs from the project.", RenderProof, RenderProofs);
        ...
        MAP.put(IncorrectRefinement, "This Refinement can only be defined over one companion object, which implements {0}", RenderTypeWithFqName);
    }
}
